...
$$
\tau_{LATE} = \mathbb{E}[Y_{1i} - Y{0i}|D_{i1} > D_{i0}]
$$
...
$$
\tau_{ITT} = \bar{Y}_{Z_i = 1} - \bar{Y}_{Z_i = 0}
$$
...
$$
\text{% compliance} = \bar{D}_{Z_i = 1} - \bar{D}_{Z_i = 0}
$$
...
$\tau_{LATE} = \frac{\bar{Y}_{Z_i = 1} - \bar{Y}_{Z_i = 0}}{\bar{D}_{Z_i = 1} - \bar{D}_{Z_i = 0}}$
...
The R function for this is as follows:
