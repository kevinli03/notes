...
subtitle: "Kevin's PSPE Notes: Regression Models"
format:
    html:
        page-layout: article
        grid:
...
If the confidence interval contains 0, we cannot conclude a relationship between $x_j$ and $y$, as 0 is a plausible value of $\beta_j$.

-   These results will always match those of the t-test.
