...
-   There is a continuum of citizens, each with a favorite position on the left-right spectrum. Let us first assume that these positions are uniformly distributed on the left-right spectrum (from -1 to 1)
