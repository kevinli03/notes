...
The conditional mean of the distribution is our model:
...
-   Where $\epsilon_i$ is the error term function - that determins the error for each point. It is normally distributed given $\epsilon_i \sim N(0, \sigma^2)$
